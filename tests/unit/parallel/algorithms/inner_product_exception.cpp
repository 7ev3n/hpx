...
void test_inner_product_exception(ExPolicy policy, IteratorTag)
{
    static_assert(
...
template <typename ExPolicy, typename IteratorTag>
void test_inner_product_exception_async(ExPolicy p, IteratorTag)
{
    typedef std::vector<std::size_t>::iterator base_iterator;
    typedef test::decorated_iterator<base_iterator, IteratorTag>
        decorated_iterator;
...
void test_inner_product_exception()
{
    ...
    test_inner_product_exception(seq, IteratorTag());
    test_inner_product_exception(par, IteratorTag());
...
{
    test_inner_product_exception<std::random_access_iterator_tag>();
    test_inner_product_exception<std::forward_iterator_tag>();
}
